...
<div class="col-sm-8 text-center"> 
  ...
  <strong>Personal Loan EMI Calculator</strong><br/>
...
<br/>
    ...
    <strong>How is my Personal Loan EMI calculated?</strong><br>
    <h1>
      <ul>
        <li>
          Your personal loan EMI can be calculated with an online personal loan calculator.</li> <br/>
